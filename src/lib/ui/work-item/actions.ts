/**
 * The mutation surface a workItem panel may call.
 *
...
export interface WorkItemActions {
  /** Merge native workItem fields; resolves false when the server refused and rolled back. */
  patchWorkItem: (patch: Record<string, unknown>) => Promise<boolean>;
  /** Move the workItem; resolves an error message, or null on success. */
  ...
  linkRelationship: (toWorkItemId: string, type: string, note?: string) => Promise<void>;
