...
CREATE UNIQUE INDEX `agent_state_unique` ON `agent_state` (`workspace_id`,`scope`,`workflow_id`,`ticket_id`,`agent_id`,`run_id`,`namespace`,`key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `agent_runs_ticket_idx` ON `agent_runs` (`workspace_id`,`ticket_id`,`created_at`);--> statement-breakpoint
...
CREATE INDEX `approval_requests_ticket_idx` ON `approval_requests` (`workspace_id`,`ticket_id`);--> statement-breakpoint
...
CREATE INDEX `jobs_ticket_idx` ON `jobs` (`workspace_id`,`ticket_id`);--> statement-breakpoint
...
CREATE INDEX `run_events_ticket_idx` ON `run_events` (`workspace_id`,`ticket_id`,`seq`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ticket_field_values_unique` ON `ticket_field_values` (`ticket_id`,`field_definition_id`);--> statement-breakpoint
CREATE INDEX `ticket_field_values_text_idx` ON `ticket_field_values` (`workspace_id`,`field_definition_id`,`value_text`);--> statement-breakpoint
CREATE INDEX `ticket_field_values_number_idx` ON `ticket_field_values` (`workspace_id`,`field_definition_id`,`value_number`);--> statement-breakpoint
CREATE INDEX `ticket_field_values_date_idx` ON `ticket_field_values` (`workspace_id`,`field_definition_id`,`value_date`);--> statement-breakpoint
CREATE INDEX `ticket_field_values_ticket_idx` ON `ticket_field_values` (`workspace_id`,`ticket_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ticket_files_unique` ON `ticket_files` (`ticket_id`,`file_id`,`relationship`);--> statement-breakpoint
CREATE INDEX `ticket_files_ticket_idx` ON `ticket_files` (`workspace_id`,`ticket_id`,`removed_at`);--> statement-breakpoint
CREATE INDEX `ticket_files_file_idx` ON `ticket_files` (`workspace_id`,`file_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `human_gate_decisions_ticket_idx` ON `human_gate_decisions` (`workspace_id`,`ticket_id`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ticket_labels_unique` ON `ticket_labels` (`ticket_id`,`label_id`);--> statement-breakpoint
CREATE INDEX `ticket_labels_label_idx` ON `ticket_labels` (`workspace_id`,`label_id`);--> statement-breakpoint
CREATE TABLE `ticket_note_revisions` (
	`id` text PRIMARY KEY NOT NULL,
	`workspace_id` text NOT NULL,
	...
	`edited_by_id` text,
	`created_at` integer NOT NULL,
	FOREIGN KEY (`note_id`) REFERENCES `ticket_notes`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE INDEX `ticket_note_revisions_note_idx` ON `ticket_note_revisions` (`note_id`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ticket_notes_ticket_idx` ON `ticket_notes` (`workspace_id`,`ticket_id`,`created_at`);--> statement-breakpoint
CREATE TABLE `ticket_relationships` (
	...
	`created_at` integer NOT NULL,
	FOREIGN KEY (`workspace_id`) REFERENCES `workspaces`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`from_ticket_id`) REFERENCES `tickets`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`to_ticket_id`) REFERENCES `tickets`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE UNIQUE INDEX `ticket_relationships_unique` ON `ticket_relationships` (`from_ticket_id`,`to_ticket_id`,`type`);--> statement-breakpoint
CREATE INDEX `ticket_relationships_from_idx` ON `ticket_relationships` (`workspace_id`,`from_ticket_id`);--> statement-breakpoint
CREATE INDEX `ticket_relationships_to_idx` ON `ticket_relationships` (`workspace_id`,`to_ticket_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ticket_state_history_ticket_idx` ON `ticket_state_history` (`workspace_id`,`ticket_id`,`entered_at`);--> statement-breakpoint
CREATE INDEX `ticket_state_history_state_idx` ON `ticket_state_history` (`workspace_id`,`state_id`,`entered_at`);--> statement-breakpoint
CREATE INDEX `ticket_state_history_open_idx` ON `ticket_state_history` (`ticket_id`,`exited_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ticket_workflow_history_ticket_idx` ON `ticket_workflow_history` (`workspace_id`,`ticket_id`,`created_at`);--> statement-breakpoint
CREATE TABLE `tickets` (
	...
	FOREIGN KEY (`origin_ticket_id`) REFERENCES `tickets`(`id`) ON UPDATE no action ON DELETE set null
);
--> statement-breakpoint
CREATE UNIQUE INDEX `tickets_key_unique` ON `tickets` (`workspace_id`,`key`);--> statement-breakpoint
CREATE UNIQUE INDEX `tickets_number_unique` ON `tickets` (`workspace_id`,`number`);--> statement-breakpoint
CREATE INDEX `tickets_board_idx` ON `tickets` (`workspace_id`,`workflow_id`,`state_id`);--> statement-breakpoint
CREATE INDEX `tickets_owner_idx` ON `tickets` (`workspace_id`,`owner_user_id`);--> statement-breakpoint
CREATE INDEX `tickets_state_entered_idx` ON `tickets` (`workspace_id`,`state_id`,`entered_state_at`);--> statement-breakpoint
CREATE INDEX `tickets_updated_idx` ON `tickets` (`workspace_id`,`updated_at`);--> statement-breakpoint
CREATE INDEX `tickets_waiting_idx` ON `tickets` (`workspace_id`,`waiting_on`);--> statement-breakpoint
